...
$config['uploaddir']=$config['site_dir'].'/72998839377r6/cicada/';
...
$config['img_url']=$config['site_url'].'72998839377r6/cicada/';

//////////////////////////////////////Шаблон//////////////////////////////////////

//доступные шаблоны 'bluestyle', 'graphene' , 'simple', 'whatsyoursolution'
$config['template_name']='graphene'; 
...
$config['site_title']='Хостинг картинок CICADA'; //Title страницы, возможно динамическое обновление 
$config['site_header_h1']='Фотохостинг CICADA'; //Текст в заголовке сайта тэг H1, возможно динамическое обновление 
...
$config['cache_time']=10*10; //в секундах, 1 час.
